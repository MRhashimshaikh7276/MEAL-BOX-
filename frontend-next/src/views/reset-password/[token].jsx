  ...
  if (!token) {
    return (
      <div className="text-center space-y-4">
        ...
        <h2 className="font-display font-bold text-2xl text-gray-900 dark:text-white">Invalid Link</h2>
        <p className="text-gray-500 dark:text-gray-400 text-sm">This password reset link is invalid or expired.</p>
