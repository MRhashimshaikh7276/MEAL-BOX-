import type { A11yOptions } from '../frontend/node_modules/swiper/types/modules/a11y.js';
import type { AutoplayOptions } from '../frontend/node_modules/swiper/types/modules/autoplay.js';
import type { ControllerOptions } from '../frontend/node_modules/swiper/types/modules/controller.js';
import type { CoverflowEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-coverflow.js';
import type { CubeEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-cube.js';
import type { FadeEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-fade.js';
import type { FlipEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-flip.js';
import type { CreativeEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-creative.js';
import type { CardsEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-cards.js';
import type { HashNavigationOptions } from '../frontend/node_modules/swiper/types/modules/hash-navigation.js';
import type { HistoryOptions } from '../frontend/node_modules/swiper/types/modules/history.js';
import type { KeyboardOptions } from '../frontend/node_modules/swiper/types/modules/keyboard.js';
import type { MousewheelOptions } from '../frontend/node_modules/swiper/types/modules/mousewheel.js';
import type { NavigationOptions } from '../frontend/node_modules/swiper/types/modules/navigation.js';
import type { PaginationOptions } from '../frontend/node_modules/swiper/types/modules/pagination.js';
import type { ParallaxOptions } from '../frontend/node_modules/swiper/types/modules/parallax.js';
import type { ScrollbarOptions } from '../frontend/node_modules/swiper/types/modules/scrollbar.js';
import type { ThumbsOptions } from '../frontend/node_modules/swiper/types/modules/thumbs.js';
import type { VirtualOptions } from '../frontend/node_modules/swiper/types/modules/virtual.js';
import type { ZoomOptions } from '../frontend/node_modules/swiper/types/modules/zoom.js';
import type { FreeModeOptions } from '../frontend/node_modules/swiper/types/modules/free-mode.js';
import type { GridOptions } from '../frontend/node_modules/swiper/types/modules/grid.js';
