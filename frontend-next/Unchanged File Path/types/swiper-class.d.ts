import type { SwiperOptions } from '../frontend/node_modules/swiper/types/swiper-options.js';
import type { CSSSelector, SwiperModule } from '../frontend/node_modules/swiper/types/shared.js';
import type { SwiperEvents } from '../frontend/node_modules/swiper/types/swiper-events.js';

import type { A11yMethods } from '../frontend/node_modules/swiper/types/modules/a11y.js';
import type { AutoplayMethods } from '../frontend/node_modules/swiper/types/modules/autoplay.js';
import type { ControllerMethods } from '../frontend/node_modules/swiper/types/modules/controller.js';
import type { CoverflowEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-coverflow.js';
import type { CubeEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-cube.js';
import type { FadeEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-fade.js';
import type { FlipEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-flip.js';
import type { CreativeEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-creative.js';
import type { CardsEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-cards.js';
import type { HashNavigationMethods } from '../frontend/node_modules/swiper/types/modules/hash-navigation.js';
import type { HistoryMethods } from '../frontend/node_modules/swiper/types/modules/history.js';
import type { KeyboardMethods } from '../frontend/node_modules/swiper/types/modules/keyboard.js';
import type { MousewheelMethods } from '../frontend/node_modules/swiper/types/modules/mousewheel.js';
import type { NavigationMethods } from '../frontend/node_modules/swiper/types/modules/navigation.js';
import type { PaginationMethods } from '../frontend/node_modules/swiper/types/modules/pagination.js';
import type { ParallaxMethods } from '../frontend/node_modules/swiper/types/modules/parallax.js';
import type { ScrollbarMethods } from '../frontend/node_modules/swiper/types/modules/scrollbar.js';
import type { ThumbsMethods } from '../frontend/node_modules/swiper/types/modules/thumbs.js';
import type { VirtualMethods } from '../frontend/node_modules/swiper/types/modules/virtual.js';
import type { ZoomMethods } from '../frontend/node_modules/swiper/types/modules/zoom.js';
import type { FreeModeMethods } from '../frontend/node_modules/swiper/types/modules/free-mode.js';
import type { ManipulationMethods } from '../frontend/node_modules/swiper/types/modules/manipulation.js';
