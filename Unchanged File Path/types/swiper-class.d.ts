import type { SwiperOptions } from '../frontend/node_modules/swiper/types/swiper-options.d.ts';
import type { CSSSelector, SwiperModule } from '../frontend/node_modules/swiper/types/shared.d.ts';
import type { SwiperEvents } from '../frontend/node_modules/swiper/types/swiper-events.d.ts';

import type { A11yMethods } from '../frontend/node_modules/swiper/types/modules/a11y.d.ts';
import type { AutoplayMethods } from '../frontend/node_modules/swiper/types/modules/autoplay.d.ts';
import type { ControllerMethods } from '../frontend/node_modules/swiper/types/modules/controller.d.ts';
import type { CoverflowEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-coverflow.d.ts';
import type { CubeEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-cube.d.ts';
import type { FadeEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-fade.d.ts';
import type { FlipEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-flip.d.ts';
import type { CreativeEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-creative.d.ts';
import type { CardsEffectMethods } from '../frontend/node_modules/swiper/types/modules/effect-cards.d.ts';
import type { HashNavigationMethods } from '../frontend/node_modules/swiper/types/modules/hash-navigation.d.ts';
import type { HistoryMethods } from '../frontend/node_modules/swiper/types/modules/history.d.ts';
import type { KeyboardMethods } from '../frontend/node_modules/swiper/types/modules/keyboard.d.ts';
import type { MousewheelMethods } from '../frontend/node_modules/swiper/types/modules/mousewheel.d.ts';
import type { NavigationMethods } from '../frontend/node_modules/swiper/types/modules/navigation.d.ts';
import type { PaginationMethods } from '../frontend/node_modules/swiper/types/modules/pagination.d.ts';
import type { ParallaxMethods } from '../frontend/node_modules/swiper/types/modules/parallax.d.ts';
import type { ScrollbarMethods } from '../frontend/node_modules/swiper/types/modules/scrollbar.d.ts';
import type { ThumbsMethods } from '../frontend/node_modules/swiper/types/modules/thumbs.d.ts';
import type { VirtualMethods } from '../frontend/node_modules/swiper/types/modules/virtual.d.ts';
import type { ZoomMethods } from '../frontend/node_modules/swiper/types/modules/zoom.d.ts';
import type { FreeModeMethods } from '../frontend/node_modules/swiper/types/modules/free-mode.d.ts';
import type { ManipulationMethods } from '../frontend/node_modules/swiper/types/modules/manipulation.d.ts';
