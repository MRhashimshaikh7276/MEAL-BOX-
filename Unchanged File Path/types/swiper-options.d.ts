import type { A11yOptions } from '../frontend/node_modules/swiper/types/modules/a11y.d.ts';
import type { AutoplayOptions } from '../frontend/node_modules/swiper/types/modules/autoplay.d.ts';
import type { ControllerOptions } from '../frontend/node_modules/swiper/types/modules/controller.d.ts';
import type { CoverflowEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-coverflow.d.ts';
import type { CubeEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-cube.d.ts';
import type { FadeEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-fade.d.ts';
import type { FlipEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-flip.d.ts';
import type { CreativeEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-creative.d.ts';
import type { CardsEffectOptions } from '../frontend/node_modules/swiper/types/modules/effect-cards.d.ts';
import type { HashNavigationOptions } from '../frontend/node_modules/swiper/types/modules/hash-navigation.d.ts';
import type { HistoryOptions } from '../frontend/node_modules/swiper/types/modules/history.d.ts';
import type { KeyboardOptions } from '../frontend/node_modules/swiper/types/modules/keyboard.d.ts';
import type { MousewheelOptions } from '../frontend/node_modules/swiper/types/modules/mousewheel.d.ts';
import type { NavigationOptions } from '../frontend/node_modules/swiper/types/modules/navigation.d.ts';
import type { PaginationOptions } from '../frontend/node_modules/swiper/types/modules/pagination.d.ts';
import type { ParallaxOptions } from '../frontend/node_modules/swiper/types/modules/parallax.d.ts';
import type { ScrollbarOptions } from '../frontend/node_modules/swiper/types/modules/scrollbar.d.ts';
import type { ThumbsOptions } from '../frontend/node_modules/swiper/types/modules/thumbs.d.ts';
import type { VirtualOptions } from '../frontend/node_modules/swiper/types/modules/virtual.d.ts';
import type { ZoomOptions } from '../frontend/node_modules/swiper/types/modules/zoom.d.ts';
import type { FreeModeOptions } from '../frontend/node_modules/swiper/types/modules/free-mode.d.ts';
import type { GridOptions } from '../frontend/node_modules/swiper/types/modules/grid.d.ts';
