...
import type Swiper from '../frontend/node_modules/swiper/types/swiper-class.d.ts';

import type { A11yEvents } from '../frontend/node_modules/swiper/types/modules/a11y.d.ts';
import type { AutoplayEvents } from '../frontend/node_modules/swiper/types/modules/autoplay.d.ts';
import type { ControllerEvents } from '../frontend/node_modules/swiper/types/modules/controller.d.ts';
import type { CoverflowEffectEvents } from '../frontend/node_modules/swiper/types/modules/effect-coverflow.d.ts';
import type { CubeEffectEvents } from '../frontend/node_modules/swiper/types/modules/effect-cube.d.ts';
import type { FadeEffectEvents } from '../frontend/node_modules/swiper/types/modules/effect-fade.d.ts';
import type { FlipEffectEvents } from '../frontend/node_modules/swiper/types/modules/effect-flip.d.ts';
import type { CreativeEffectEvents } from '../frontend/node_modules/swiper/types/modules/effect-creative.d.ts';
import type { CardsEffectEvents } from '../frontend/node_modules/swiper/types/modules/effect-cards.d.ts';
import type { HashNavigationEvents } from '../frontend/node_modules/swiper/types/modules/hash-navigation.d.ts';
import type { HistoryEvents } from '../frontend/node_modules/swiper/types/modules/history.d.ts';
import type { KeyboardEvents } from '../frontend/node_modules/swiper/types/modules/keyboard.d.ts';
import type { MousewheelEvents } from '../frontend/node_modules/swiper/types/modules/mousewheel.d.ts';
import type { NavigationEvents } from '../frontend/node_modules/swiper/types/modules/navigation.d.ts';
import type { PaginationEvents } from '../frontend/node_modules/swiper/types/modules/pagination.d.ts';
import type { ParallaxEvents } from '../frontend/node_modules/swiper/types/modules/parallax.d.ts';
import type { ScrollbarEvents } from '../frontend/node_modules/swiper/types/modules/scrollbar.d.ts';
import type { ThumbsEvents } from '../frontend/node_modules/swiper/types/modules/thumbs.d.ts';
import type { VirtualEvents } from '../frontend/node_modules/swiper/types/modules/virtual.d.ts';
import type { ZoomEvents } from '../frontend/node_modules/swiper/types/modules/zoom.d.ts';
import type { FreeModeEvents } from '../frontend/node_modules/swiper/types/modules/free-mode.d.ts';
